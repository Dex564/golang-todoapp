...
// @Success      200 {object} GetStatisticsResponse "Успешно изменённая задача"
...
func (h *StatisticsHTTPHandler) GetStatistics(rw http.ResponseWriter, r *http.Request) {
	...
	statistics, err := h.statisticsService.GetStatistics(ctx, user_id, from, to)
	if err != nil {
