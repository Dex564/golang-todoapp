...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_Dex564_golang-todoapp_internal_core_transport_http_response.ErrorResponse"
                        }
                    },
                    "500": {
        ...
        "/users/{id}": {
            ...
            "patch": {
                "description": "Изменение информации об уже существующем пользователе\n### Логика обновления полей (Three-state logic):\n1. **Поле не передано**: поле игнорируется, значение в БД не меняется\n2. **Явно передано значение**: ` + "`" + `\"phone_number\": \"+71112223344\"` + "`" + ` - устанавливается новое поле\n3. **Передан null**: ` + "`" + `\"phone_number: null\"` + "`" + ` - очищает поле в БД (set to NULL)\nОграничения: ` + "`" + `username` + "`" + ` не может быть выставлено как null",
                "consumes": [
                    "application/json"
                ],
                "produces": [
    ...
    "definitions": {
        "github_com_Dex564_golang-todoapp_internal_core_transport_http_response.ErrorResponse": {
            "type": "object",
            "properties": {
                "error": {
                    "type": "string",
        ...
        "internal_features_tasks_transport_http.CreateTaskRequest": {
            ...
            "properties": {
                ...
                "description": {
                    ...
                    "maxLength": 1000,
                    "minLength": 1,
                    "example": "Сделать дз по математике"
                },
                "title": {
                    "type": "string",
                    "maxLength": 100,
        ...
        "internal_features_tasks_transport_http.CreateTaskResponse": {
            ...
            "properties": {
                ...
                "created_at": {
                    "type": "string",
                    "example": "2026-02-12:30:00Z"
                },
                "description": {
                    "type": "string",
                    "example": "Сделать до четверга домашнее задаиние по математике"
                },
                "id": {
                    "type": "integer",
                    "example": 15
